...
def pickleModel(type, model,cv_unigram):
    ...
    model_filename = dataFolderPath+ "mnb_" + type + ".pkl"
    pickle.dump(model,open(model_filename,'wb'))
    cv_filename = dataFolderPath + "cv_" + type + ".pkl"
    pickle.dump(cv_unigram, open(cv_filename, 'wb'))

def tuneModel(train_unigram_mapping,train_df_tagged_tag,validation_unigram_mapping,validation_df_tagged_tag):
    finalAlphaVal=0
    currMaxScore = 0;
    i =0
    while i<=5:
...
def NLBUnigramV3WithTunningPickle(type, train_df_tagged_sentence, train_df_tagged_tag, test_df_tagged_sentence, test_df_tagged_tag, validation_df_tagged_sentence, validation_df_tagged_tag):
    ...
    NLB = MultinomialNB()
    #tune the model on validation set
    tunnedAlphaVal = tuneModel(train_unigram_mapping,train_df_tagged_tag,validation_unigram_mapping,validation_df_tagged_tag)
...
def NLBBigramV2(type, train_df_tagged_sentence, train_df_tagged_tag, test_df_tagged_sentence, test_df_tagged_tag , validation_df_tagged_sentence, validation_df_tagged_tag):
    ...
    #validation
    validation_unigram_mapping = cv_digrams.transform(validation_df_tagged_sentence)
    ...
    # tune the model on validation set
    tunnedAlphaVal = tuneModel( train_digrams_mapping, train_df_tagged_tag, validation_unigram_mapping,validation_df_tagged_tag)
    NLB_bigrams.alpha = tunnedAlphaVal
    print(" tunnedAlphaVal ", tunnedAlphaVal)
    model_digrams = NLB_bigrams.fit(train_digrams_mapping, train_df_tagged_tag)
    # pickle model
    pickleModel(type,model_digrams,cv_digrams)
...
def NLBUnigramsBigramV2(type, train_df_tagged_sentence, train_df_tagged_tag, test_df_tagged_sentence,test_df_tagged_tag, validation_df_tagged_sentence, validation_df_tagged_tag):
    ...
    # validation
    validation_unigram_mapping = cv_unigrams_digrams.transform(validation_df_tagged_sentence)
    ...
    # tune the model on validation set
    tunnedAlphaVal = tuneModel(train_unigrams_digrams_mapping, train_df_tagged_tag, validation_unigram_mapping,
                               validation_df_tagged_tag)
    NLB_unigrams_bigrams.alpha = tunnedAlphaVal
    print(" tunnedAlphaVal ", tunnedAlphaVal)
    model_unigrams_digrams = NLB_unigrams_bigrams.fit(train_unigrams_digrams_mapping,train_df_tagged_tag)
    # pickle model
    pickleModel(type,model_unigrams_digrams,cv_unigrams_digrams)
    predictions_unigrams_bigrams = model_unigrams_digrams.predict(test_unigrams_bigrams_mapping)
    score_val_unigrams_bigrams = metrics.accuracy_score(test_df_tagged_tag,predictions_unigrams_bigrams)
...
NLBUnigramV3WithTunningPickle("uni", train_df_tagged_sentence, train_df_tagged_tag, test_df_tagged_sentence, test_df_tagged_tag, validation_df_tagged_sentence, validation_df_tagged_tag)
# bigrams with stopwords
NLBBigramV2("bi",train_df_tagged_sentence,train_df_tagged_tag ,test_df_tagged_sentence,test_df_tagged_tag, validation_df_tagged_sentence, validation_df_tagged_tag)
# unigrams+bigrams with stopwords
NLBUnigramsBigramV2("uni_bi",train_df_tagged_sentence,train_df_tagged_tag ,test_df_tagged_sentence,test_df_tagged_tag, validation_df_tagged_sentence, validation_df_tagged_tag)
...
NLBUnigramV3WithTunningPickle("uni_ns",train_df_tagged_sentence_withoutstopwords,train_df_tagged_tag_withoutstopwords,test_df_tagged_sentence_withoutstopwords,test_df_tagged_tag_withoutstopwords,validation_df_tagged_sentence_withoutstopwords,validation_df_tagged_tag_withoutstopwords)
# # #bigrams without stopwords
NLBBigramV2("bi_ns",train_df_tagged_sentence_withoutstopwords,train_df_tagged_tag_withoutstopwords,test_df_tagged_sentence_withoutstopwords,test_df_tagged_tag_withoutstopwords,validation_df_tagged_sentence_withoutstopwords,validation_df_tagged_tag_withoutstopwords)
# #unigrams+bigrams without stopwords
NLBUnigramsBigramV2("uni_bi_ns",train_df_tagged_sentence_withoutstopwords,train_df_tagged_tag_withoutstopwords,test_df_tagged_sentence_withoutstopwords,test_df_tagged_tag_withoutstopwords,validation_df_tagged_sentence_withoutstopwords,validation_df_tagged_tag_withoutstopwords)